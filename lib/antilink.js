...
const ALLOWED_LINKS = [ 'www.google.com', 'google.com', 'https://www.google.com', 'https://google.com' ];
...
function containsURL(str) {
	if (ALLOWED_LINKS.includes(str)) return false; // simple whitelist for safe links
